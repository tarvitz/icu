...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('banlist_userbanlist', (
        ...
        db.send_create_signal('banlist', ['UserBanList'])

        # Adding model 'ServerBanList'
        db.create_table('banlist_serverbanlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plain_type', self.gf('django.db.models.fields.CharField')(default='default', max_length=64)),
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True, blank=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal('banlist', ['ServerBanList'])


    def backwards(self, orm):
        
        # Deleting model 'UserBanList'
        db.delete_table('banlist_userbanlist')

        # Deleting model 'ServerBanList'
        db.delete_table('banlist_serverbanlist')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 16, 1, 13, 3, 236902)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 16, 1, 13, 3, 236686)'}),
